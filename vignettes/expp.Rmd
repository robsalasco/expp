...
data(bluetit_breeding)
bluetit_breeding[is.na(bluetit_breeding)] = 'NA' #this is apparently necessary because in the current version 'kable' cannot deal with NA values. Change back afterwards.
