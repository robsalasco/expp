...
|id   |  year_|   id|        x|        y|female  |male  |layingDate  |male_age  |male_tarsus  |study_area  |
|:----|------:|----:|--------:|--------:|:-------|:-----|:-----------|:---------|:------------|:-----------|
|351  |   2011|   17|  4417837|  5334163|NA      |NA    |102         |adult     |NA           |Westerholz  |
|352  |   2011|  160|  4417574|  5334549|NA      |m383  |103         |juv       |17.16        |Westerholz  |
|353  |   2011|  261|  4417593|  5334857|f174    |m348  |101         |adult     |17.045       |Westerholz  |
|354  |   2011|  174|  4417433|  5334600|f186    |m238  |103         |adult     |16.799999    |Westerholz  |
|355  |   2011|   80|  4417728|  5334311|f218    |m361  |101         |adult     |17.5         |Westerholz  |
|356  |   2011|  262|  4417552|  5334861|f224    |m280  |99          |adult     |17.110001    |Westerholz  |
...
# For the sake of conciseness only two years are used in the folowing
# analyses
b = b[c("2009", "2010")]
e = e[c("2009", "2010")]
...
```r
polygonsDat = mapply(DirichletPolygons, x = breedingDat, boundary = split(p, 
    p$year_))
```
...
for (year in c("2009", "2010")) {
    plot(eppOut[[year]], cex = 0.7, lwd = 0.5, border = "navy")
    title(main = year)
}
```
...
plot(eppOut10, zoom = box, maxlag = 2, cex = 0.7, border = "white", col = "grey70", 
    zoom.col = "bisque")
```
